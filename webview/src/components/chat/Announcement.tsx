  ...
  return (
    <div
      ...
      <ul style={{ margin: "0 0 8px", paddingLeft: "12px" }}>
        <li>
          Responses are now streamed + a yellow text decoration animation to keep track of Cline's progress as he edits
          files.
        </li>
        <li>
          Cancel button to give Cline feedback if he goes off in the wrong direction, giving you more control over
          tasks.
        </li>
        <li>
